...
def generate_launch_description():
    pkg = get_package_share_directory('wheel_open_loop')
    default_params = os.path.join(pkg, 'config', 'wheel_open_loop.yaml')
    ...
    node = Node(
        package='wheel_open_loop',
        executable='wheel_open_loop_node',
        name='wheel_open_loop',
        output='screen',
        emulate_tty=True,
        parameters=[
